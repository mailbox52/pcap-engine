/* @ts-self-types="./pcap_engine.d.ts" */
...
export class PcapIndex {
    static __wrap(ptr) {
        const obj = Object.create(PcapIndex.prototype);
        obj.__wbg_ptr = ptr;
        PcapIndexFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PcapIndexFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     */
    cap_len(start, end) {
        const ret = wasm.pcapindex_cap_len(this.__wbg_ptr, start, end);
     ...
     */
    complete() {
        const ret = wasm.pcapindex_complete(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    count() {
        const ret = wasm.pcapindex_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    filter(query) {
        ...
        const ret = wasm.pcapindex_filter(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
    ...
    format() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.pcapindex_format(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    issues() {
        const ret = wasm.pcapindex_issues(this.__wbg_ptr);
     ...
     */
    linktype(start, end) {
        const ret = wasm.pcapindex_linktype(this.__wbg_ptr, start, end);
        var v1 = getArrayU16FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 2, 2);
        return v1;
    }
     ...
     */
    offset(start, end) {
        const ret = wasm.pcapindex_offset(this.__wbg_ptr, start, end);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    ts_nsec(start, end) {
        const ret = wasm.pcapindex_ts_nsec(this.__wbg_ptr, start, end);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    ts_sec(start, end) {
        const ret = wasm.pcapindex_ts_sec(this.__wbg_ptr, start, end);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
}
if (Symbol.dispose) PcapIndex.prototype[Symbol.dispose] = PcapIndex.prototype.free;
 ...
 * @returns {any}
 */
export function link_preview(packet, linktype) {
    const ptr0 = passArray8ToWasm0(packet, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.link_preview(ptr0, len0, linktype);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {PcapIndex}
 */
export function parse_pcap_bytes(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_pcap_bytes(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PcapIndex.__wrap(ret[0]);
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./pcap_engine_bg.js": import0,
    };
}

const PcapIndexFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_pcapindex_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pcap_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
